...
public class CommentHub(IMediator mediator) : Hub //SignalR uses HTTP requests and websockets
{
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        if (string.IsNullOrEmpty(activityId)) throw new HubException("No activitiy with this id");
